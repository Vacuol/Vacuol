...
//	#define KALMAN_Q  0.02     #define KALMAN_R 7.0000
...
//  angle.roll = atan2(2*q2q3 + 2*q0q1, -2*q1q1 - 2*q2q2 + 1); // roll
   IMangle.ipitch = asin(-2*q1q3 + 2*q0q2); // pitch
	 IMangle.iyaw = atan2(2*(q1*q2 + q0*q3),q0*q0+q1*q1-q2*q2-q3*q3) * 57.3; 
	/*          关于地磁如何进行倾角补偿                       */    
